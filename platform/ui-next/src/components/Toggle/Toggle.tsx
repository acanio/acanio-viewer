...
const toggleVariants = cva(
  'inline-flex items-center justify-center rounded-none text-primary-foreground/80 font-medium transition-colors hover:bg-primary/20 hover:text-primary-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 data-[state=on]:bg-customblue-100 data-[state=on]:text-highlight data-[state=off]:bg-primary/20 data-[state=off]:text-highlight',
  {
    variants: {
      variant: {
