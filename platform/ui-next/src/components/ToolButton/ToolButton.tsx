...
const baseClasses = '!rounded-none inline-flex items-center justify-center';
const defaultClasses =
  'bg-transparent text-primary-active hover:bg-primary-dark hover:text-primary-light';
