        ...
        >
          ...
          <AccordionItem value="segmentation-list">
            ...
            <AccordionContent>
              <div className="mb-0">
                {/* Header Controls */}
                <div className="bg-customblue-40 flex h-10 w-full items-center space-x-1 rounded-t px-1.5">
                  <DropdownMenu>
                ...
                <AccordionItem value="segmentation-display">
                  ...
                  <AccordionContent>
                    <div className="bg-customblue-40 mb-0.5 space-y-2 rounded-b px-1.5 pt-0.5 pb-3">
